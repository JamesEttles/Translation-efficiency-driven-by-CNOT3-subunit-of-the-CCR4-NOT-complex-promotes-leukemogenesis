...
transcript_to_gene_ID <- read_csv(file = "N:/R11/bioinformatics_resources/FASTAs/human/GENCODE/v38/transcript_info/gencode.v38.pc_transcripts_gene_IDs.csv", col_names = c("transcript", "gene", "gene_sym"))
...
#write out as csv
write_csv(file = file.path(parent_dir, "Analysis/most_abundant_transcripts/most_abundant_transcripts_IDs_-sh33_1.csv"), most_abundant_transcripts)
write.table(file = file.path(parent_dir, "Analysis/most_abundant_transcripts/most_abundant_transcripts_-sh33_1.txt"), most_abundant_transcripts$transcript, row.names = F, col.names = F, quote = F)
write.csv(file = file.path(parent_dir, "Analysis/most_abundant_transcripts/CNOT3_KD_tpms.csv"), isoform_tpm)
